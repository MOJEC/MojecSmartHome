package com.mojec.mojecsmarthome.databinding.model;
...
public class User extends BaseObservable {
    ...
    public ObservableField<String> numberOfPosts = new ObservableField<>();
    ...
    public ObservableField<String> getNumberOfPosts() {
